...
var budgetController = (function(){
    ...
    return {
        addItem: function(type, des, val){
            ...
            //Puse it inot our data structure
...
var UIController = (function(){
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            //Replace the placeholder text with dsom actual data
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var setupEventListeners = function(){
        ...
        document.addEventListener('keypress', function(event) {
            //console.log(event);
            //Keycode for Enter, which is for older browsers.
    ...
    var updatePercentages = function() {
        ...
        // 3. Update teh user interface with the new percentages
    ...
    var ctrlAddItem = function() {
        ...
        if(input.description !== "" && !isNaN(input.value) && input.value > 0){
            // 2. Add teh item to the budget controller
